...
public class PolymorphismFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button polyVideoButton =(Button) v.findViewById(R.id.polymorphismVideoButton);
        polyVideoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), PolymorphismVideoActivity.class);
                startActivity(i);
            }
        });
        return v;
